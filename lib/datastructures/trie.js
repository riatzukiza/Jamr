...
Trie = Trie.privateMethod("isInSet", (function(k) {
    ...
    return this.suffixes.get(k);
}));
Trie = Trie.privateMethod("isNotInSet", (function(k) {
    /* src/macros/defs.sibilant:186:47 */

    return this.suffixes.set(k,new this.constructor(this));
}));
Trie = Trie.method("add", (function(key) {
    /* src/macros/defs.sibilant:186:47 */

    return maybe.binary(this._isInSet.bind(this, key),
                        this._isNotInSet.bind(this, key),
                        this.suffixes.get(key));
}));
